...
const FeaturedGameCard = ({
    ...
    return (
        <div
            id={id.toString()}
            className={`flex w-full rounded-md mt-8 
                `}
        >
            <div className="">
                <img
            ...
            <div className="ml-4 mr-16 flex flex-col justify-between ">
                <h4 className="text-xl font-bold truncate">{name}</h4>
                <PlatformIcons platformNames={platformNames} />
                <div className="Tags flex gap-2 my-2 flex-wrap">
                    {renderGenreTags()}
                </div>
                <div>
                    <p className="font-light">
                        Description text for game Lorem ipsum dolor sit amet
                        consectetur adipisicing elit. Quae saepe quam,
                        doloremque eum modi dignissimos sit ab? Ipsam reiciendis
                        quod exercitationem dignissimos architecto dolorum
                        possimus aspernatur? Fugit commodi suscipit sed.
                        Description text for game Lorem ipsum dolor sit amet
                        consectetur adipisicing elit. Quae saepe quam,
                        doloremque eum modi dignissimos sit ab? Ipsam reiciendis
                        quod exercitationem dignissimos architecto dolorum
