...
const CommentList = ({ postId }: CommentListProps) => {
    ...
    useEffect(() => {
        getComments()
    }, [comments.length]) // Right now it only runs once, so the new comment is only added when we reload the page. If we include [reviews] above, then it infinite loops, which we dont want.
